...
namespace Chess
{
	...
	public:
		...
		// if there is no piece at the end position (i.e. this is not a capture move).
		// It does not check whether the path from start to end is clear since not all piece types require a clear path.
